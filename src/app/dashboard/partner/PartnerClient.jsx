...
export default function PartnerProgramPage({ localization }) {
    ...
    const columns = [
        ...
        {
            header: localization?.partner_customer,
            accessor: "customer",
            cellClassName: "text-text/80 dark:text-white/80 font-medium"
        },
        {
            header: localization?.partner_rate,
            accessor: "rate",
        ...
        {
            header: localization?.partner_transaction,
            cell: (row) => (
    ...
    if (isLoading) {
        return (
            <div className="flex min-h-[400px] flex-col items-center justify-center gap-4">
                ...
                <p className="text-text/60 animate-pulse">{localization?.partner_loading}</p>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="flex min-h-[400px] flex-col items-center justify-center gap-6 text-center">
                ...
                <div>
                    <h3 className="text-xl font-bold text-text">{localization?.partner_error_title}</h3>
    ...
    return (
        <div className="flex flex-col gap-8 pb-10">
            ...
            <RevealInAnimation direction="up">
                <DashboardHeader
                    title={localization?.partner_title}
                    subtitle={localization?.partner_subtitle}
                >
                </DashboardHeader>
            </RevealInAnimation>
            ...
            <FaderInAnimation direction="up" delay={0.2}>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <StatsCard
                        title={localization?.partner_total_affiliate}
                    ...
                    />
                    <StatsCard
                        title={localization?.partner_amount_used}
            ...
            <FaderInAnimation direction="up" delay={0.6}>
                <div className="space-y-4">
                    <div className="flex items-center justify-between px-2">
                        <h3 className="text-xl font-bold text-primary font-accent">{localization?.partner_transaction_history}</h3>
                    </div>
                    {allEntries.length > 0 ? (
                        <DataTable
                            columns={columns}
                            data={paginatedEntries.map(entry => {
                                ...
                                return {
                                    ...
                                    status: isEarnings ? localization?.partner_earnings : localization?.partner_used,
                        ...
                        <div className="flex flex-col items-center justify-center py-12 bg-white dark:bg-background-dark/30 rounded-2xl border border-divider">
                            ...
                            <p className="text-text/60 font-medium">{localization?.partner_no_transactions}</p>
                        </div>
                    )}
                </div>
            </FaderInAnimation>
