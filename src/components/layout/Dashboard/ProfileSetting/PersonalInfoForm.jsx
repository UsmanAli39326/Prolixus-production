    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Input
                ...
                type="email"
                placeholder={localization?.profile_placeholder_email || "email@example.com"}
                inputClassName={inputClass}
            ...
            <Input
                ...
                type="tel"
                placeholder={localization?.profile_placeholder_mobile || "+1 (555) 123-4567"}
                inputClassName={inputClass}
            ...
            <Input
                ...
                placeholder={localization?.profile_placeholder_postcode || "Post Code"}
                inputClassName={inputClass}
            ...
            <Input
                ...
                placeholder={localization?.profile_placeholder_city || "City"}
                inputClassName={inputClass}
            ...
            <Input
                ...
                placeholder={localization?.profile_placeholder_street || "Street Address"}
                inputClassName={inputClass}
